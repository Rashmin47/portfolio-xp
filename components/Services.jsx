  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className="text-center max-w-2xl mx-auto mt-b mb-12 font-[family-name:var(--font-ovo)]"
      >
        I am a Fullstack Developer from Nepal with 2 years of experience in
        multiple companies.
      </motion.p>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        {serviceData.map(({ icon, title, description, link }, index) => (
          <motion.div
            ...
            key={index}
            className="border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-x-1 

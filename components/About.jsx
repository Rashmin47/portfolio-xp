    ...
    <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        <div className="w-64 sm:w-80 rounded-3xl max-w-none">
          <Image src={assets.pp} alt="user" className="w-full rounded-3xl" />
        </div>
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-ovo">
            ...
            morning coffee, design graphics that are so sharp they might cut
            you, and build websites that could make even your grandma say, "Wow,
            this is sleek!" Whether he’s coding, designing, or just being his
            awesome self, I make sure your digital presence doesn’t just work,
            it wows!
          </p>
          ...
          <h4 className="my-6 text-gray-700 font-family-ovo dark:text-white/80">
            Tools I use
          </h4>
